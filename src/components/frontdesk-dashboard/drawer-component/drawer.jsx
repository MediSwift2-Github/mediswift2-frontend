...
export const DrawerComponent = () => {
    ...
    const [isDeletePatientDialogOpen, setDeletePatientDialogOpen] = useState(false);
    ...
    const handleClearQueue = async () => {
        try {
            await fetch(`${API_URL}/api/queue/remove?clearAll=true`, { method: 'DELETE' });
    ...
    return (
        <DrawerPaper variant="permanent" anchor="left">
            ...
            />
            <Button color="error" onClick={handleDeletePatientClick}>Delete Patient</Button>
            <Button color="warning" onClick={handleClearQueue}>Clear Queue</Button>
            <DeletePatientDialog
